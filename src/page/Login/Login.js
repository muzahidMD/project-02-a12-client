            ...
            <div className="card w-96 bg-base-100 shadow-xl">
                <div className="card-body">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        {signInError}
                        <input className='btn w-full hover:bg-white hover:text-black bg-secondary text-white rounded-full' type="submit" value='Login' />
                    </form>
                    ...
                    <button
                        ...
                        className="btn w-full hover:bg-white hover:text-black bg-secondary text-white rounded-full"
